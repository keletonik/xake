...
import { AppBrand, EnvBadge, ThemeToggle, TopbarGroup } from "@xake/ui";
...
export default function AppLayout({ children }: { children: ReactNode }) {
  return (
    <div className="xake-shell" style={{ gridTemplateColumns: "var(--rail-w) 1fr" }}>
      ...
      <main className="xake-shell__main" style={{ position: "relative", display: "grid", gridTemplateColumns: "1fr var(--drawer-w)" }}>
